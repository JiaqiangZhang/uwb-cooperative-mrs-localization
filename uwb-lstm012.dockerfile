...
COPY uwb-lstm-docker012.py /app
...
COPY models/normal_tagID/lstm_uwb_0_1 /app/models/lstm_uwb_0_1
COPY models/normal_tagID/lstm_uwb_0_2 /app/models/lstm_uwb_0_2

CMD ["python3", "/app/uwb-lstm-docker012.py"]
