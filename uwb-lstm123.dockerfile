...
COPY uwb-lstm-docker123.py /app
...
COPY models/normal_tagID/lstm_uwb_1_2 /app/models/lstm_uwb_1_2
COPY models/normal_tagID/lstm_uwb_1_3 /app/models/lstm_uwb_1_3

CMD ["python3", "/app/uwb-lstm-docker123.py"]
