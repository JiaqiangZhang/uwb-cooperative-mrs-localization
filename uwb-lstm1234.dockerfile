...
COPY uwb-lstm-docker1234.py /app
...
COPY models/normal_tagID/lstm_uwb_1_4 /app/models/lstm_uwb_1_4
COPY models/normal_tagID/lstm_uwb_2_3 /app/models/lstm_uwb_2_3

CMD ["python3", "/app/uwb-lstm-docker1234.py"]
