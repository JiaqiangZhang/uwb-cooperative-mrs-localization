...
COPY uwb-lstm-docker034.py /app
...
COPY models/normal_tagID/lstm_uwb_0_3 /app/models/lstm_uwb_0_3
COPY models/normal_tagID/lstm_uwb_0_4 /app/models/lstm_uwb_0_4

CMD ["python3", "/app/uwb-lstm-docker034.py"]
