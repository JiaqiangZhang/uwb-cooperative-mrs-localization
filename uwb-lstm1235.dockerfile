...
COPY uwb-lstm-docker1235.py /app
...
COPY models/previous/lstm_uwb_1_5 /app/models/lstm_uwb_1_5
COPY models/previous/lstm_uwb_2_3 /app/models/lstm_uwb_2_3

CMD ["python3", "/app/uwb-lstm-docker1235.py"]
